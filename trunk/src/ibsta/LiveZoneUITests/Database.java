...
public class Database {
	  ...
	  private static final String DATABASE_NAME = "UITests.db";
	  ...
	  public int AddLocationRow()
	  {
		  ContentValues contentValues = new ContentValues();
		  contentValues.put(COLUMN_NAME, "test insert");
		  contentValues.put(COLUMN_LATITUDE, "11");
		  contentValues.put(COLUMN_LONGTITUDE, "22");
		  contentValues.put(COLUMN_ACCURACY, "10.0");
		  contentValues.put(COLUMN_ENABLED, 1);
